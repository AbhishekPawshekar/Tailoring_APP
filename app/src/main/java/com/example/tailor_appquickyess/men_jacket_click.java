...
public class men_jacket_click extends AppCompatActivity {
    TextInputLayout neck,shoulder,chest,cuff_circumference,waist,bicep_width,total_length,seat,sleevelength;
    Button next;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_men_jacket_click);
        neck=findViewById(R.id.neck_men_jacket);
        shoulder=findViewById(R.id.shoulder_men_jacket);
        chest=findViewById(R.id.chest_men_jacket);
        cuff_circumference=findViewById(R.id.cuff_circumference_length_men_jacket);
        waist=findViewById(R.id.waist_men_jacket);
        bicep_width=findViewById(R.id.bicep_men_jacket);
        total_length=findViewById(R.id.Total_length_men_jacket);
        seat=findViewById(R.id.seat_men_jacket);
        sleevelength=findViewById(R.id.sleeve_length_men_jacket);
        next=findViewById(R.id.next_button_jacket);
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("Type_Of_cloth","Men_Jacket");
