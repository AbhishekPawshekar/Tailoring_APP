...
public class men_shirt_click extends AppCompatActivity {
    TextInputLayout neck,shoulder,chest,cuff_circumference,waist,bicep_width,total_length,seat,sleevelength;
    Button next;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_men_shirt_click);
        neck=findViewById(R.id.neck_men_shirt);
        shoulder=findViewById(R.id.sholder_men_shirt);
        chest=findViewById(R.id.chestmen_shirt);
        cuff_circumference=findViewById(R.id.cuff_circumference_length_men_shirt);
        waist=findViewById(R.id.waist_men_shirt);
        bicep_width=findViewById(R.id.bicep_men_shirt);
        total_length=findViewById(R.id.Total_length_men_shirt);
        seat=findViewById(R.id.seat_length_men_shirt);
        sleevelength=findViewById(R.id.sleeve_length_men_shirt);
        next=findViewById(R.id.next_button_shirt);
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("Type_Of_cloth","Men_Shirt");
