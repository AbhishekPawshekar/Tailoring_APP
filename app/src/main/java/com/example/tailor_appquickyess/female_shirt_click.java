...
public class female_shirt_click extends AppCompatActivity {
    TextInputLayout neck,shoulder,chest,cuff_circumference,waist,bottom_width,total_length,seat,sleevelength;
    Button next;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_female_shirt_click);
        neck=findViewById(R.id.neck_female_shirt);
        shoulder=findViewById(R.id.shoulder_female_shirt);
        chest=findViewById(R.id.chest_female_shirt);
        cuff_circumference=findViewById(R.id.cuff_circumference_length_female_shirt);
        waist=findViewById(R.id.waist_female_shirt);
        total_length=findViewById(R.id.total_length_female_shirt);
        seat=findViewById(R.id.seat_female_shirt);
        sleevelength=findViewById(R.id.sleeve_length_female_shirt);
        next=findViewById(R.id.next_button_female_shirt);
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("Type_Of_cloth","Female_Shirt");
                startActivity(i);
            }
        });
    }
